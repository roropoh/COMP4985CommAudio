...
BOOL InitDevice(int device);
	...
	private: System::Windows::Forms::Button^  record_voice_button;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->record_voice_button = (gcnew System::Windows::Forms::Button());
			...
			// record_voice_button
			// 
			this->record_voice_button->Location = System::Drawing::Point(320, 56);
			this->record_voice_button->Name = L"record_voice_button";
			this->record_voice_button->Size = System::Drawing::Size(57, 19);
			this->record_voice_button->TabIndex = 17;
			this->record_voice_button->Text = L"voice";
			this->record_voice_button->UseVisualStyleBackColor = true;
			this->record_voice_button->Click += gcnew System::EventHandler(this, &ClientGUI::record_voice_button_Click);
			// 
			// ClientGUI
			// 
			...
			this->Controls->Add(this->record_voice_button);
...
#pragma endregion
	...
	private: System::Void record_voice_button_Click(System::Object^  sender, System::EventArgs^  e) {
				 StartRecording();

			 }
	private: System::Void stop_button_Click(System::Object^  sender, System::EventArgs^  e) {
				 //BASS_ChannelStop(voice);
				 StopRecording();
			 ...
			 // DWORD read = 0;
			 // float *chunk;
			 // chunk = (float*)malloc(2048*sizeof(float));
			 // DWORD CHUNK_SIZE = 1024;
			 // memset(chunk, 0, sizeof(chunk));

			 // HRECORD voice1;
			 // BASS_RecordInit(1);
			 // //voice = BASS_RecordStart(freq, 2, 0, 0, 0); // start recording
			 // voice1 = BASS_RecordStart(freq, 2, 0, 0, 0); // start recording
			 // BASS_ChannelPlay(voice1, FALSE);
			 //}
