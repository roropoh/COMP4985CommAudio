...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// play_button
			// 
			this->play_button->Location = System::Drawing::Point(101, 261);
			...
			// rew_button
			// 
			this->rew_button->Location = System::Drawing::Point(21, 261);
			...
			// pause_button
			// 
			this->pause_button->Location = System::Drawing::Point(183, 261);
			...
			// stop_button
			// 
			this->stop_button->Location = System::Drawing::Point(264, 261);
			...
			// fwd_button
			// 
			this->fwd_button->Location = System::Drawing::Point(345, 261);
			...
			this->songlist->Location = System::Drawing::Point(21, 298);
			...
			// progressBar1
			// 
			this->progressBar1->Location = System::Drawing::Point(21, 229);
			...
			// shuffle_button
			// 
			this->shuffle_button->Location = System::Drawing::Point(427, 175);
			...
			this->client_status_box->Location = System::Drawing::Point(21, 121);
			this->client_status_box->Multiline = true;
			this->client_status_box->Name = L"client_status_box";
			this->client_status_box->Size = System::Drawing::Size(399, 93);
			...
			this->ClientSize = System::Drawing::Size(523, 488);
